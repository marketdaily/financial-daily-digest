...
OUTPUT_HEARTBEATS = [
    # 2026-09-01 老闆令退役:line_group_runner.sh 的 5 個 cron 班次已從 crontab 移除
    # (備份 ~/.marketdaily-fallback/crontab.bak.20260901-213357)。來源刻意不再產出,
    # 這條產出物心跳留著只會永久紅=哨兵自殺,故一併下架。若日後恢復排程,把本條加回來。
