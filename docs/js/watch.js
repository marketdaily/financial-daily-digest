...
const I18N = {
  zh: {
    ...
    pos_title: "💼 我的部位", pos_unsigned: "永豐帳務 API 尚未生效(帳號回報 signed=false)。要兩步都完成才會解鎖:①到永豐「簽署中心」簽署 API 條款(證券／期貨需分開簽) ②完成 API 登入＋下單測試(週一至五 08:00–20:00,審核約 5 分鐘)。生效後這裡會自動顯示真實持股與未實現損益。",
