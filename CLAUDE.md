...
- **內容/創作**：content-engine、crosspost、content-repurposing、content-refresh、content-research-writer、brand-voice-amplifier（⚠️enhancer 退役）、podcast-outline、video-style、video-editing、story-script、youtube-summarizer、video-watcher（真的看影片:下載+抽格視覺讀+timeline beats,IG牆有Playwright fallback）、article-extractor、recording-analysis（本地錄音→逐字稿→結構化分析）
