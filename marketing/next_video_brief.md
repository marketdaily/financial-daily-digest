...
**剪輯節奏規格(2026-07-09 定,快剪是剪出來的不是生成出來的)**:
- 混亂段(0–15s):後製切成 **1–2 秒/拍點**——3 個鏡頭用 punch-in(100%→115% 裁切)、速度 ramp 變出 6–8 個拍點,卡著通知音牆的節奏排;越接近驟停點剪越快
- 從容段(15–25s):**3–4 秒長鏡頭不動**,和前段的落差就是敘事;鐘鳴那一拍停在她微笑的特寫
- 端卡(25–30s):一刀進,impact hit 同幀落
- 原則:節奏在剪輯檯決定,生成只管把素材拍好;同批素材可剪快慢兩版 A/B,零額度
