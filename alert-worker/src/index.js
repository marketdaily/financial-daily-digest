...
const ADMIN_INFO_KEYWORDS = [
  ...
  "AI 技術雷達",
  "預警已推全體",
  // 2026-07-30:這三類每天都會產生、且不是事故,不歸檔就會把真告警淹掉(當天一次清出 13 則未收尾摘要)。
  // 推播照送(recordAdminEvent 在推播之後跑),只是後台不再留成「未解決」。
  "還沒收乾",        // Stop hook 的 open_items 快照;活的現況在 scripts/open_items.py
  "信息差巡邏",      // 產品訊號輸出,07-26 已從 🔴 降為 🟢
  "自測(非事故)",   // 守衛管道自測,訊息本身即載明不需處理
  "讓路交接",        // 自主機器偵測到 Delvin 上線→停手並回報進度,是設計行為
  "[資訊]",
  "[info]",
];
